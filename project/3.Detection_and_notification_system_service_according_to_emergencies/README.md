# 객체 인식을 통해 응급상황 발생 감지 및 알람기능 서비스
...
|  11  | 서비스 배포                                  | 김명환 |    2020.04.27     | 2020.04.28 |                |
...
- 2020년 04월 08일
  ...
  - 학습 데이터가 한정적이므로 실시간 웹캠을 통해 서비스를 시현하기에는 무리가 있다고 판단하여 기존 학습된 데이터와 유사한 실내 영상을 이용하여 웹 서버에서 응급상황 발생여부를 확인하고 사용자에게 알람을 제공하는 과정을 시현할 예정(영상 + 웹 서버 + SMS?)
- 2020년 04월 09일
  
  - 웹 서비스를 구현하기 위한 기술 조사 진행예정