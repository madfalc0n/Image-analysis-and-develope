...
input_tensor = Input(shape=(300, 300,3), dtype='float32', name='input')
...
train_v, test = train_test_split(train, test_size=0.2, random_state=42)
...
model.compile(loss='categorical_crossentropy', optimizer=opt,metrics = ['categorical_accuracy',quadratic_kappa_coefficient])
# 네트워크를 학습시킵니다
