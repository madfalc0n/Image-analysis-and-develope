...
pretrained_path = {'se_resnext50_32x4d': 'C:/Users/user/Desktop/QT/model/se_resnext50_32x4d-a260b3a4.pth'}
...
def submit(coefficients, file_path, device):
    ...
    for fold in range(CFG.n_fold):
        ...
        weights_path = f'C:/Users/user/Desktop/QT/model/fold{fold}_se_resnext50.pth'
        print("check2")
...
def var(file_path):
    ...
    preds = np.array(pd.read_csv('C:/Users/user/Desktop/QT/model/p_data.csv')).flatten().astype(np.float64)
    valid_labels = np.array((pd.read_csv('C:/Users/user/Desktop/QT/model/v_data.csv'))).flatten().astype(np.float32)
